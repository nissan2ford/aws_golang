...
var _logsCollection = _interopRequireDefault(require("./logsCollection"));
...
var _setApiGatewayAccessLogFormat = _interopRequireDefault(require("./setApiGatewayAccessLogFormat"));
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.t0 = hook;
                  _context.next = _context.t0 === 'before:package:createDeploymentArtifacts' ? 3 : _context.t0 === 'after:package:createDeploymentArtifacts' ? 17 : _context.t0 === 'before:deploy:function:packageFunction' ? 20 : _context.t0 === 'after:deploy:function:packageFunction' ? 24 : _context.t0 === 'before:aws:package:finalize:saveServiceState' ? 27 : _context.t0 === 'before:deploy:deploy' ? 32 : _context.t0 === 'before:aws:deploy:deploy:createStack' ? 36 : _context.t0 === 'after:aws:deploy:finalize:cleanup' ? 37 : _context.t0 === 'before:info:info' ? 40 : _context.t0 === 'after:info:info' ? 43 : _context.t0 === 'dashboard:dashboard' ? 45 : _context.t0 === 'before:logs:logs' ? 47 : _context.t0 === 'before:metrics:metrics' ? 50 : _context.t0 === 'before:remove:remove' ? 53 : _context.t0 === 'after:remove:remove' ? 56 : _context.t0 === 'before:invoke:local:invoke' ? 67 : _context.t0 === 'after:invoke:local:invoke' ? 71 : _context.t0 === 'before:offline:start:init' ? 74 : _context.t0 === 'before:step-functions-offline:start' ? 75 : _context.t0 === 'login:login' ? 76 : _context.t0 === 'logout:logout' ? 79 : _context.t0 === 'generate-event:generate-event' ? 82 : _context.t0 === 'test:test' ? 85 : 88;
                  break;
                ...
                case 7:
                  ...
                  (0, _deployment.createAndSetDeploymentUid)(self);
                  _context.next = 12;
                ...
                case 14:
                  _context.next = 16;
                  return (0, _setApiGatewayAccessLogFormat.default)(self);
                ...
                case 29:
                  _context.next = 31;
                  return (0, _logsCollection.default)(self);
