...
function () {
  ...
  regeneratorRuntime.mark(function _callee(ctx) {
    var template, logGroups, accessKey, _ref2, Account, destinationOpts, destinationArn, _ref3, logGroupIndex, logGroupKey, logGroupName, filterPattern;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            logGroups = (0, _utils.pickResourceType)(template, 'AWS::Logs::LogGroup');
          ...
          case 29:
            ...
            for (logGroupIndex in logGroups) {
              logGroupKey = logGroups[logGroupIndex].key;
              logGroupName = logGroups[logGroupIndex].resource.Properties.LogGroupName;
              filterPattern = logGroupName.startsWith('/aws/api-gateway/') ? _utils.API_GATEWAY_FILTER_PATTERN : _utils.LAMBDA_FILTER_PATTERN;
              template.Resources[`CloudWatchLogsSubscriptionFilter${(0, _utils.upperFirst)(logGroupKey)}`] = {
